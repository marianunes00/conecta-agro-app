...
export default function PropertyMap({ stations }: { stations: Station[] }) {
  ...
  return (
    <div className="relative w-full h-[calc(100dvh-135px)] min-h-[520px] overflow-hidden rounded-3xl bg-[#132215] shadow-inner select-none">
        ...
        >
          <defs>
            <linearGradient id="plot1" x1="0" y1="0" x2="1" y2="1">
              <stop offset="0%" stopColor="#2e4d29" />
              <stop offset="100%" stopColor="#1e381b" />
            </linearGradient>
            <linearGradient id="plot2" x1="0" y1="0" x2="1" y2="1">
              <stop offset="0%" stopColor="#3d6136" />
              <stop offset="100%" stopColor="#2c4b26" />
            </linearGradient>
          ...
          <rect width="600" height="750" fill="#1b2d18" />
          ...
          <g stroke="#ffffff" strokeWidth="1.8" opacity="0.85">
            ...
            <polygon points="50,220 120,180 150,380 70,420" fill="#192817" opacity="0.6" />
            <polygon points="180,600 380,560 390,700 190,720" fill="#243b20" opacity="0.7" />
          </g>
      ...
      >
        <div className="relative flex items-center justify-center">
          <div className="absolute h-10 w-10 rounded-full bg-emerald-500/25 animate-ping" />
          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#1b5e20] text-white border-2 border-white shadow-lg">
      ...
      {/* Estação 2 (Selecionada - Azul com pulso) */}
      <div
      ...
      >
        <div className="relative flex items-center justify-center">
          ...
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-600 text-white border-2 border-white shadow-xl ring-4 ring-blue-400/40">
            <div className="h-3 w-3 rounded-full bg-white" />
          </div>
        </div>
      </div>

      {/* Estação 3 (Online - Verde) */}
      <div
      ...
      >
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#1b5e20] text-white border-2 border-white shadow-md">
      ...
      <div className="absolute right-4 bottom-32 z-10">
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-full bg-white text-neutral-800 shadow-lg border border-neutral-100 hover:bg-neutral-50 active:scale-95 transition-all"
        >
      ...
      <div className="absolute bottom-4 inset-x-4 z-10 flex flex-col gap-2">
        ...
        <div className="flex items-center justify-between rounded-2xl bg-white/95 backdrop-blur-md px-4 py-3 shadow-lg border border-white/60">
          <div>
            <p className="text-xs font-bold text-neutral-800 mb-1">Estações</p>
        ...
        <div className="flex items-center justify-between rounded-2xl bg-white/95 backdrop-blur-md px-4 py-3 shadow-lg border border-white/60 cursor-pointer hover:bg-white transition">
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs font-semibold text-neutral-800">
              Talhão 1 <span className="text-neutral-400 mx-1">|</span> Umidade: 38%
            </p>
          </div>
